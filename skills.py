...
def eners():
    webbrowser.open('https://eners.kgeu.ru', new=2)
...
def ite_direkcia():
    webbrowser.open('https://kgeu.ru/Employee/List/44?idShablonMenu=6', new=2)
...
def prohod():
    webbrowser.open('https://kgeu.ru/Document/GetDocument/2f977ee1-3ddd-4b11-a263-06739987ac4c', new=2)

def license():
    webbrowser.open('https://kgeu.ru/Document/GetDocument/99a9866f-528b-405d-b06e-eb399939541b', new=2)

def akkred():
    webbrowser.open('https://kgeu.ru/Document/GetDocument/a4e98107-f565-4dae-b67c-2eadfe0426c2', new=2)

def cost():
    webbrowser.open('https://kgeu.ru/Document/GetDocument/ad4c14d2-6a6f-4fb7-b9a4-19e864d2d7e4', new=2)

def date():
    webbrowser.open('https://kgeu.ru/Document/GetDocument/54a2de6d-f7a8-4483-ad22-b19e49e3b680', new=2)


def mesta():
    webbrowser.open('https://kgeu.ru/Abitur/Bachelor', new=2)
