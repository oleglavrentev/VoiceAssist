...
def classify_cosine_similarity(user_input, vectorized_data_set,
    ...
    for key in vectorized_data_set:
      dist = cosine_similarity(user_input_vectorized.reshape(1, -1), vectorized_data_set[key].reshape(1, -1))
      if dist > cl_dist:
        cl_dist = dist
        cl_phrase = key
    return cl_phrase

def recognize(data, tokenizer, vectorized_data_set):
    '''
    ...
    answer = classify_cosine_similarity(data, vectorized_data_set,
                                        tokenizer)
    ...
    with sd.RawInputStream(samplerate=samplerate, blocksize=16000, device=device[0], dtype='int16',
        ...
        while True:
            ...
            if rec.AcceptWaveform(data):
                ...
                recognize(data, tokenizer, vectorized_data_set)
            # else:
